 ...
 * [FragmentTrendingNow.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [FragmentTrendingNow.newInstance] factory method to
 * create an instance of this fragment.
 */
class FragmentTrendingNow : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val view = inflater.inflate(R.layout.fragment_trending_now, container, false)
        initUI(view)
    ...
    companion object {
         ...
         * @return A new instance of fragment FragmentTrendingNow.
         */
        // TODO: Rename and change types and number of parameters
        fun newInstance(param1: String, param2: String): FragmentTrendingNow {
            val fragment = FragmentTrendingNow()
            val args = Bundle()
